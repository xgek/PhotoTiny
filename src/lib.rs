...
#[derive(Debug)]
pub struct PhotoTinyProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PhotoTinyProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PhotoTiny processing");
    
    let mut processor = PhotoTinyProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PhotoTinyProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PhotoTinyProcessor::new(false);
